...
L['UseBlizzardPostBFAAutoAdjustment'] = 'Use Blizzard Post-BFA Automatic Adjustment'
L['UseBlizzardPostBFAAutoAdjustmentDesc'] = 'Selecting this option the RightMultiActionBars will be adjusted and scaled using the new method and margings introduced by Blizzard in BFA (NOT RECOMMENDED). Usually is better to let ClassicUI handle this by leaving the option unselected.'
L['UseMinimapFrameAsTopMargin'] = 'Set the Top Margin for auto scaling at bottom of Minimap frame'
L['UseMinimapFrameAsTopMarginDesc'] = 'Selecting this option prevents the RightMultiActionBars from overlapping on the Minimap frame. Instead, they will be automatically scaled to a smaller size. If this option is not selected, the top margin is the top of the screen and will only be automatically scaled if it is exceeded.'
L['AllowExceedTopMarginWithTwoStatusBars'] = 'Allow exeed the Top Margin when Two Status Bars are shown'
L['AllowExceedTopMarginWithTwoStatusBarsDesc'] = 'When two StatusBars are shown, the RightMultiActionBars are shifted up slightly. Selecting this option allows them to exceed the upper margin with this offset. With this option not selected, the RightMultiActionBars will be automatically scaled so that they do not exceed this margin.'
L['ExpBar'] = true
L['HonorBar'] = true
L['AzeriteBar'] = true
L['ArtifactBar'] = true
...
L['CLASSICUI_HELP_LINE8'] = '/ClassicUI reset: Resets the current profile to the default values.'
