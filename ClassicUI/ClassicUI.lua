...
function ClassicUI:MF_PLAYER_ENTERING_WORLD()
	...
	CharacterMicroButton.FlashBorder:SetPoint("TOPLEFT", ProfessionMicroButton, "TOPLEFT", -2, 3)
	...
	PlayerSpellsMicroButton:SetPoint("BOTTOMLEFT", CharacterMicroButton, "BOTTOMRIGHT", -2, 0)
	PlayerSpellsMicroButton:SetFrameStrata("MEDIUM")
	PlayerSpellsMicroButton:SetFrameLevel(3)
	PlayerSpellsMicroButton:SetNormalAtlas("hud-microbutton-Spellbook-Up", true)
	PlayerSpellsMicroButton:SetPushedAtlas("hud-microbutton-Spellbook-Down", true)
	PlayerSpellsMicroButton:SetDisabledAtlas("hud-microbutton-Spellbook-Disabled", true)
	PlayerSpellsMicroButton:SetHighlightAtlas("hud-microbutton-highlight")
	PlayerSpellsMicroButton:SetNormalTexture("Interface\\Buttons\\UI-MicroButton-Spellbook-Up")
	PlayerSpellsMicroButton:SetPushedTexture("Interface\\Buttons\\UI-MicroButton-Spellbook-Down")
	PlayerSpellsMicroButton:SetHighlightTexture("Interface\\Buttons\\UI-MicroButton-Hilight", "ADD")
	PlayerSpellsMicroButton:SetDisabledTexture("Interface\\Buttons\\UI-MicroButton-Spellbook-Disabled")
	...
	ProfessionMicroButton:ClearAllPoints()
	ProfessionMicroButton:SetPoint("BOTTOMLEFT", PlayerSpellsMicroButton, "BOTTOMRIGHT", -2, 0)
	ProfessionMicroButton:SetFrameStrata("MEDIUM")
	ProfessionMicroButton:SetFrameLevel(3)
	ProfessionMicroButton:SetNormalAtlas("hud-microbutton-Talents-Up", true)
	ProfessionMicroButton:SetPushedAtlas("hud-microbutton-Talents-Down", true)
	ProfessionMicroButton:SetDisabledAtlas("hud-microbutton-Talents-Disabled", true)
	ProfessionMicroButton:SetHighlightAtlas("hud-microbutton-highlight")
	ProfessionMicroButton:SetNormalTexture("Interface\\Buttons\\UI-MicroButton-Talents-Up")
	ProfessionMicroButton:SetPushedTexture("Interface\\Buttons\\UI-MicroButton-Talents-Down")
	ProfessionMicroButton:SetHighlightTexture("Interface\\Buttons\\UI-MicroButton-Hilight", "ADD")
	ProfessionMicroButton:SetDisabledTexture("Interface\\Buttons\\UI-MicroButton-Talents-Disabled")
	...
	AchievementMicroButton:SetPoint("BOTTOMLEFT", ProfessionMicroButton, "BOTTOMRIGHT", -2, 0)
	...
	for _, bar in ipairs(ClassicUI.STBMbars) do
		...
		elseif ((bar.priority == 1) or (bar.barIndex == 1)) then	-- ReputationBar (priority = 1) (barIndex = 1)
			...
			if (bar.ShouldBeVisible == nil) then
				bar.ShouldBeVisible = function(self)
					local name, reaction, minFaction, maxFaction, value, factionID = C_Reputation.GetWatchedFactionData()
					return name ~= nil
				end
			end
			hooksecurefunc(bar, "Update", function(self)
				local _, colorIndex, _, _, _, factionID = C_Reputation.GetWatchedFactionData()
		...
		if ((iActionButton.UpdateFlyout ~= nil) and (iabfbt ~= nil) and not(ClassicUI.cached_ActionButtonInfo.hooked_UpdateFlyout[iActionButton])) then
			hooksecurefunc(iActionButton, "UpdateFlyout", function(self, isButtonDownOverride)
				...
				if not(typeABprofile.BLStyle == 1) and not(typeABprofile.BLStyle0UseNewFlyoutBorder) then
					...
					local isMouseOverButton = GetMouseFoci() == self
