...
L['Enable Extra Options even when ClassicUI core is disabled'] = true
...
L['expBarAlwaysShowRestedBar'] = '[ExpBar] Show the rested bar even if it exceeds the level'
...
L['BLStyle0NeverReduceSpellActivationAlert'] = 'Never reduce the effect of the classic SpellActivationAlert animation'
...
L['BLStyle0NeverReduceSpellActivationAlertDesc'] = 'Enable this option to always show the full effect of the classic SpellActivationAlert animation instead of replacing it with a subtler static texture when Blizzard determines that it should be reduced based on conditions involving \'Assisted Highlight\' and the \'Single-Button Assistant\'.'
...
L['Bags'] = true
L['BuffAndDebuffFrames'] = 'Buffs and Debuffs'
L['Chat'] = true
...
L['ScaleELP-MID-ButtonDesc'] = 'Scale ELP Midnight Button (ClassicUI Default: $$**$$)'
...
L['DesaturateActionsWithoutResources'] = 'Desaturate actions without enough resources'
L['DesaturateActionsWithoutResourcesDesc'] = 'Desaturate actions that cannot be used because of a lack of resources (mana, energy, rage, etc.)'
...
L['Changed profile options'] = true
...
L['EXTRA_OPTIONS_DESC'] = 'Some addons already include these extra features. Before activating any extra functionality in ClassicUI, check that no other addon already performs the same function; otherwise, errors or unexpected behavior could occur.'
L['EXTRA_FRAMES_DESC'] = 'This addon allows you to restore/modify some Additional Frames that are not directly related to the Action Bars, such as the Minimap, the PlayerFrame, or the TargetFrame. The options related to these Additional Frames are independent of the rest of the addon, can be enabled/disabled individually, and are taken into account even if the main ClassicUI addon is disabled.'
...
L['GUILD_PANEL_MODE_OPTIONS_DESC'] = 'This additional functionality allows you to recover the old guild panel. You can choose to open the old guild panel through some access modes (keybind, left, middle or right click on the guild microbutton, ...) and keep other access modes for the new social guild panel. If you are in combat, the new social guild panel is always opened because the old guild panel frame is protected by Blizzard and cannot be opened in combat.'
...
L['KEYBINDS_VISIBILITY_OPTIONS_DESC'] = 'This extra option allows you to hide the Keybinds Text from Action Buttons. You can hide keybinds but show the dot range, or hide all keybinds completely. You can also choose to hide the ActionButtons Names.'
L['KEYBINDS_VISIBILITY_OPTIONS_SELECT_DESC'] = 'Select whether you want to hide the keybinds from action bars'
L['HIDE_ACTIONBUTTONS_NAME_DESC'] = 'Select whether you want to hide the ActionButtons Names, which are usually shown when a macro is assigned to an ActionButton'
L['REDRANGE_OPTIONS_DESC'] = 'Enable this option to show the entire icon in red when the spell is out of range instead of only showing the keybind text in red.'
L['GREYONCOOLDOWN_OPTIONS_DESC'] = 'Enable this option to show the icon desaturated when the spell is on cooldown.'
L['LOSSOFCONTROLUI_OPTION_DESC'] = 'When you suffer a CC effect, the default behavior of your action bars is to set a Cooldown according to the duration of that CC. This can be annoying for some players. You can enable this extra option to remove that cooldown from the bars for CC effects.'
...
L['CLASSICUI_HELP_LINE7'] = '/ClassicUI forceextraOptions <enable|disable|on|off> or /ClassicUI feo <enable|disable|on|off>: Enable or disable extra options even when ClassicUI is disabled.'
L['CLASSICUI_HELP_LINE8'] = '/ClassicUI profiles: Shows the profiles ClassicUI config panel.'
L['CLASSICUI_HELP_LINE9'] = '/ClassicUI changed: Shows profile options changed from their default values.'
L['CLASSICUI_HELP_LINE10'] = '/ClassicUI reset: Resets the current profile to the default values.'
